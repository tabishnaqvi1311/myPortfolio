...
export const Navbar = () => {
    ...
    const navLinks: NavLink[] = [
        ...
        },
        {
            id: 69,
            title: "Resume",
            link: "https://drive.google.com/file/d/1LJkzJuSLBxuWwZe3GFoYBxS0H2jmsU7G/view?usp=drive_link",
        },
    ];
        ...
        <div className="bricolage-grotesque-300">
            ...
            <nav className="flex justify-between items-center md:p-4 p-2">
                ...
                >
                    {navLinks.map((nav) => (
                        <li
                            key={nav.id}
                            className={
                                "p-7 uppercase tracking-widest h-[50px] w-[125px] items-center flex justify-center"
                            }
                        >
                ...
                <div className="sm:hidden flex m-10">
                    ...
                    <div
                        className={`${toggle ? "flex" : "hidden"} absolute top-28 right-7 bg-white p-2 text-black z-10 rounded-xl`}
                    >
