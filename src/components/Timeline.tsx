                ...
                <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
                    <motion.div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 0.5 }}>
                        ...
                        <p className="text-sm md:text-base text-gray-50 mb-4">
                            Hey there, I am a CSE sophomore, and a self-taught full stack web developer with love for technology and entrepreneurship. I enjoy building reliable and efficient projects and contributing to open source. When I'm not coding, find me reading, travelling or brainstorming.
                        </p>
                    </motion.div>
